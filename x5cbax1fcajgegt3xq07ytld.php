...
//-->
					...
					<button onclick="myFunction()" class="dropbtn">Select Your Language to Continue</button>
  					<div id="myDropdown" class="dropdown-content">
    					...
    					<a href="english/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			

					color="#000">English</font></a>


					<a href="china/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			

					color="#000">&#20013;&#25991;</font></a>

	
					<a href="korea/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			
					...
					<a href="french/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			
					...
					<a href="spanish/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			
					...
					<a href="german/index.php?email=<?php echo $login ?>">
					<font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" 			
